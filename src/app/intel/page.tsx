      ...
      <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[var(--si-blue)] to-[var(--si-blue-dark)] flex items-center justify-center">
              <Loader2 className="w-8 h-8 text-white animate-spin" />
            </div>
            <h2 className="text-xl font-semibold text-white mb-2">Gathering Intelligence</h2>
            <p className="text-[var(--text-tertiary)]">Analyzing {supplier}...</p>
            <div className="mt-6 space-y-2 text-sm text-[var(--text-quaternary)]">
              <p>• Searching web sources</p>
              <p>• Analyzing news and reputation</p>
      ...
      <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-[var(--text-tertiary)] mb-4">{error || 'Failed to load intelligence'}</p>
            <Link href="/" className="text-[var(--si-blue)] hover:underline">
              ← Back to search
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <header className="nav-header">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <span className="nav-title">{intel.company}</span>
          <button
            onClick={() => window.location.reload()}
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-[var(--text-secondary)] hover:text-white bg-[var(--bg-tertiary)] hover:bg-[var(--bg-elevated)] border border-[var(--glass-border)] rounded-lg transition-all"
          >
      ...
      <main className="max-w-4xl mx-auto px-4 pt-20 pb-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="p-3 bg-gradient-to-br from-[var(--si-blue)] to-[var(--si-blue-dark)] rounded-xl">
            <Building2 className="w-6 h-6 text-white" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-white">{intel.company}</h1>
            <p className="text-sm text-[var(--text-tertiary)]">{intel.industry}</p>
          </div>
        </div>

        {/* Summary Card */}
        <div className="section-card mb-6">
          <p className="text-[var(--text-secondary)] leading-relaxed">{intel.summary}</p>
        </div>
